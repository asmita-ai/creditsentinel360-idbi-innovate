...
st.set_page_config(page_title="CreditSentinel 360 | IDBI Innovate", page_icon="🛡️", layout="wide")
...
st.markdown('<p class="big-title">🛡️ CreditSentinel 360</p>', unsafe_allow_html=True)
